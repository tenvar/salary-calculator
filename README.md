...
> `TaxableIncome = Salary + Bonuses + CarValue + FoodValue`
...
> `FinalIncomeTax = Max(0, GrossTax - TaxDiscount)`
...
*   **Пенсия:** 6% от (Salary + Bonuses). *Без учета авто*.
*   **Керен Иштальмут:** 2.5% от (Salary + Bonuses).
